...
static const char *const yytname[] =
{
  ...
  "PRINT", "PLUS", "MINUS", "MUL", "DIV", "ASSIGN", "SEMI", "LPAREN",
  "RPAREN", "$accept", "program", "stmt", "expr", YY_NULLPTR
};
...
{
       9,    11,     8,    28,    -7,     3,     3,    -7,    -7,    -7,
      -7,     3,    18,    -5,    10,     3,     3,     3,     3,    -7,
      19,    -7,    29,    29,    29,    29,    -7
};
...
{
      13,    15,    16,    17,    18,    14,     9,    10,    20,    22,
      23,    24,    25,     1,     2,    11,    15,    16,    17,    18,
       6,     5,     0,    21,    15,    16,    17,    18,     7,    19,
      26,     0,     1,     2,     8,    15,    16,    17,    18
};

static const yytype_int8 yycheck[] =
{
       6,     6,     7,     8,     9,    11,     3,     4,    13,    15,
      16,    17,    18,     4,     5,    12,     6,     7,     8,     9,
      12,    10,    -1,    13,     6,     7,     8,     9,     0,    11,
      11,    -1,     4,     5,     3,     6,     7,     8,     9
};
...
{
       0,     4,     5,    15,    16,    10,    12,     0,    16,     3,
       4,    12,    17,    17,    17,     6,     7,     8,     9,    11,
      13,    13,    17,    17,    17,    17,    11
};
...
#line 1090 "parser.tab.c"
  ...
  case 5: /* stmt: PRINT LPAREN expr RPAREN SEMI  */
#line 38 "parser.y"
        {
            printf("Print Statement\n");
            generateCode((yyvsp[-2].node));
        }
...
#line 1129 "parser.tab.c"
  ...
  case 11: /* expr: ID  */
#line 51 "parser.y"
         { (yyval.node) = createIdNode((yyvsp[0].id)); }
